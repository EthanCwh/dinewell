...
class Post(db.Model):
    ...
    def __repr__(self):
        return f'Post("{self.title}", "{self.date_posted}", "{self.menu_options}", "{self.content_menu}", "{self.staff_options}", "{self.content_staff}", "{self.content_additional}", "{self.user_id}")'
